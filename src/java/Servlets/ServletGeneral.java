    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (pojo.getId() != 0) {
                ...
                sesion.setAttribute("ape2", pojo.getApe2());
                sesion.setAttribute("login", pojo.getUser());
                sesion.setAttribute("password", pojo.getPass());
                sesion.setAttribute("email", pojo.getEmail());
                sesion.setAttribute("telefono", pojo.getTelefono());
                sesion.setAttribute("id_tipo_usuario", pojo.getId_tipo_usuario());

                //*****//
                
                String idUsuario=String.valueOf(pojo.getId());
                ...
                getServletContext().getRequestDispatcher("/contenidosesion.jsp")
