...
public class Mantenimiento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int id_usuario=Integer.parseInt(request.getParameter("idUsuarioOculta"));
        String sql = "insert into entrega (id, id_documento, id_actividad,nota) values("+null+","+id_documento+","+id_usuario+","+"0"+")";
        MySql con = new MySql();
        con.execute(sql);
